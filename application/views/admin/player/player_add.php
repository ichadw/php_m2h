	        ...
	        <div class="col-md-12">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="attack" name="attack" placeholder="Enter attack" required>
                  </div>
                  <div class="form-group">
                      <label for="technic">Technic</label>
                      <input type="text" class="form-control" id="technic" name="technic" placeholder="Enter technic" required>
                  </div>
                  <div class="form-group">
                      <label for="stamina">Stamina</label>
                      <input type="text" class="form-control" id="stamina" name="stamina" placeholder="Enter stamina" required>
                  </div>
                  <div class="form-group">
                      <label for="defense">Defense</label>
                      <input type="text" class="form-control" id="defense" name="defense" placeholder="Enter defense" required>
                  </div>
                  <div class="form-group">
                      <label for="power">Power</label>
                      <input type="text" class="form-control" id="power" name="power" placeholder="Enter power" required>
                  </div>
                  <div class="form-group">
                      <label for="speed">Speed</label>
                      <input type="text" class="form-control" id="speed" name="speed" placeholder="Enter speed" required>
                  </div>
                  <div class="form-group">
